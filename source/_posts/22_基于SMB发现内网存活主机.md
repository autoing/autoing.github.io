---
title: 22、基于SMB发现内网存活主机
date: 2019-09-21 19:04:25
comments: true
categories: 
 - Micro8系列
---
...
```  
![](../do/media/c4d807b384fa3fbd0de85b80b2a38e59.jpg)
...
```  
![](../do/media/5206dc9e56a970261d19557e81a2dd73.jpg)
...
```  
![](../do/media/3fd308a951925bf5a20f8f6568f1c84a.jpg)

### 基于CMD：
```code
for /l %a in (1,1,254) do start /min /low telnet 192.168.1.%a 445
```
![](../do/media/eab2b645fe2065a540c49a842dfd2ecf.jpg)
...
```
![](../do/media/7c6b67ffd6f089b88778bb732f0bf949.jpg)
...
2>$null}
```
![](../do/media/9d87d933207df8058f867f3d208a30a1.jpg)
...
```
![](../do/media/fd7db2c22f6d1deac9303d3bdbabcd4f.jpg)  
